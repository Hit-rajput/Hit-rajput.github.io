...
const ProjectDetail: React.FC<ProjectDetailProps> = ({ project, onClose }) => {
  return (
    <div className="w-full max-w-[1400px] mx-auto animate-fade-in-up">
      ...
      <div className="glass-panel p-6 md:p-10 rounded-2xl border border-white/10 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 relative z-10">
          ...
          <div className="flex-1 order-2 lg:order-1">
            ...
            <div className="space-y-8">
              ...
              {/* Tech Stack */}
              <div>
                <h3 className="text-sm font-bold text-white/50 mb-4 uppercase tracking-widest">Tech Stack</h3>
                <div className="flex flex-wrap gap-4">
                  {project.techStack.map((tech, i) => (
                    <div key={i} className="flex items-center gap-2 bg-white/5 border border-white/10 px-3 py-2 rounded-lg hover:bg-white/10 transition-colors cursor-default">
              ...
              <div className="flex flex-wrap gap-4 pt-6">
                {project.liveUrl && (
                  <a 
                    ...
                    className="flex items-center gap-2 bg-white text-black px-6 py-3 rounded-full font-bold text-sm tracking-wide hover:bg-accent-primary hover:text-black transition-all hover:scale-105"
                  >
                ...
                {project.repoUrl && (
                  <a 
                    ...
                    className="flex items-center gap-2 bg-transparent border border-white/20 text-white px-6 py-3 rounded-full font-bold text-sm tracking-wide hover:bg-white/10 transition-all"
                  >
                    <span>VIEW CODE</span>
